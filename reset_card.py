  ...
  while True:
    ...
    if status == MIFAREReader.MI_OK:
        ...
        if status == MIFAREReader.MI_OK:
            ...
            maxseau=00
            conso=00
            s = b"X" + b"20180507" + (conso).to_bytes(2, byteorder='big') + (maxseau).to_bytes(1, byteorder='big') + b"YAPO"                     
        ...
        if status == MIFAREReader.MI_OK:
            ...
            maxseau=10
            conso=20
            s = b"X" + b"20190401" + (conso).to_bytes(2, byteorder='big') + (maxseau).to_bytes(1, byteorder='big') + b"YAPO"                     
